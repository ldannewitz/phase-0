...
--I had trouble getting the first test to pass because I was including the word "object" in the definition. It worked after I just defined adam with the empty braces.
--I also had trouble passing test 5 because I didn't know to use 'remove'. Once I googled that function it worked.

2. How difficult was it to add and delete properties outside of the object itself?
--It was actually much easier than I expected. This challenge was helpful to practice these concepts and see them at work.

3. What did you learn about manipulating objects in this challenge?
--I learned how to add and delete properties from an object outside of the object itself.
